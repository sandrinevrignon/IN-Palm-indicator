###################################################Fonction création dictionnaire info weather
################################################################################################################
...
######################################################################################################################################
############################################################Création dictionnaire complet avec toutes les informations
######################################################################################################################################
...
def dictionnary_complete(countfounction,printlist) :
    ...
    global dictionnary
    dictionnary = {'2008': {'January': {'Rainfall': 12.17, 'Rain frequency': 9},
                            'February': {'Rainfall': 15.51, 'Rain frequency': 8},
                            'March': {'Rainfall': 47.76, 'Rain frequency': 15},
                            'April': {'Rainfall': 250.93, 'Rain frequency': 15},
                            'May': {'Rainfall': 199.5, 'Rain frequency': 11},
                            'June': {'Rainfall': 128.3, 'Rain frequency': 8},
                            'July': {'Rainfall': 180.0, 'Rain frequency': 8},
                            'August': {'Rainfall': 222.0, 'Rain frequency': 10},
                            'September': {'Rainfall': 317.5, 'Rain frequency': 13},
                            'October': {'Rainfall': 320.8, 'Rain frequency': 18},
                            'November': {'Rainfall': 153.4, 'Rain frequency': 9},
                            'December': {'Rainfall': 170.5, 'Rain frequency': 11}},
                   '2009': {'January': {'Rainfall': 107.5, 'Rain frequency': 8},
                            'February': {'Rainfall': 113.7, 'Rain frequency': 13},
                            'March': {'Rainfall': 115.89, 'Rain frequency': 13},
                            'April': {'Rainfall': 301.5, 'Rain frequency': 13},
                            'May': {'Rainfall': 76.4, 'Rain frequency': 9},
                            'June': {'Rainfall': 211.4, 'Rain frequency': 8},
                            'July': {'Rainfall': 152.0, 'Rain frequency': 5},
                            'August': {'Rainfall': 318.5, 'Rain frequency': 8},
                            'September': {'Rainfall': 187.5, 'Rain frequency': 10},
                            'October': {'Rainfall': 465.5, 'Rain frequency': 16},
                            'November': {'Rainfall': 223.5, 'Rain frequency': 13},
                            'December': {'Rainfall': 588.5, 'Rain frequency': 15}},
                   '2010': {'January': {'Rainfall': 329.5, 'Rain frequency': 16},
                            'February': {'Rainfall': 127.0, 'Rain frequency': 11},
                            'March': {'Rainfall': 398.7, 'Rain frequency': 17},
                            'April': {'Rainfall': 282.5, 'Rain frequency': 14},
                            'May': {'Rainfall': 170.5, 'Rain frequency': 11},
                            'June': {'Rainfall': 101.5, 'Rain frequency': 6},
                            'July': {'Rainfall': 150.0, 'Rain frequency': 14},
                            'August': {'Rainfall': 245.5, 'Rain frequency': 14},
                            'September': {'Rainfall': 230.1, 'Rain frequency': 12},
                            'October': {'Rainfall': 215.0, 'Rain frequency': 12},
                            'November': {'Rainfall': 224.4, 'Rain frequency': 15},
                            'December': {'Rainfall': 90.0, 'Rain frequency': 10}},
                   '2011': {'January': {'Rainfall': 269.0, 'Rain frequency': 21},
                            'February': {'Rainfall': 127.4, 'Rain frequency': 6},
                            'March': {'Rainfall': 230.6, 'Rain frequency': 15},
                            'April': {'Rainfall': 208.4, 'Rain frequency': 17},
                            'May': {'Rainfall': 104.3, 'Rain frequency': 10},
                            'June': {'Rainfall': 72.2, 'Rain frequency': 6},
                            'July': {'Rainfall': 30.1, 'Rain frequency': 6},
                            'August': {'Rainfall': 100.0, 'Rain frequency': 6},
                            'September': {'Rainfall': 201.8, 'Rain frequency': 11},
                            'October': {'Rainfall': 413.0, 'Rain frequency': 16},
                            'November': {'Rainfall': 233.2, 'Rain frequency': 17},
                            'December': {'Rainfall': 249.0, 'Rain frequency': 20}},
                   '2012': {'January': {'Rainfall': 145.3, 'Rain frequency': 14},
                            'February': {'Rainfall': 187.9, 'Rain frequency': 18},
                            'March': {'Rainfall': 170.4, 'Rain frequency': 15},
                            'April': {'Rainfall': 229.9, 'Rain frequency': 12},
                            'May': {'Rainfall': 117.4, 'Rain frequency': 9},
                            'June': {'Rainfall': 52.1, 'Rain frequency': 8},
                            'July': {'Rainfall': 78.5, 'Rain frequency': 11},
                            'August': {'Rainfall': 264.1, 'Rain frequency': 12},
                            'September': {'Rainfall': 156.46, 'Rain frequency': 8},
                            'October': {'Rainfall': 277.2, 'Rain frequency': 16},
                            'November': {'Rainfall': 392.5, 'Rain frequency': 21},
                            'December': {'Rainfall': 542.0, 'Rain frequency': 15}},
                   '2013': {'January': {'Rainfall': 195.5, 'Rain frequency': 12},
                            'February': {'Rainfall': 168.8, 'Rain frequency': 16},
                            'March': {'Rainfall': 242.6, 'Rain frequency': 12},
                            'April': {'Rainfall': 227.8, 'Rain frequency': 12},
                            'May': {'Rainfall': 247.7, 'Rain frequency': 13},
                            'June': {'Rainfall': 90.0, 'Rain frequency': 7},
                            'July': {'Rainfall': 82.5, 'Rain frequency': 4},
                            'August': {'Rainfall': 111.9, 'Rain frequency': 7},
                            'September': {'Rainfall': 248.4, 'Rain frequency': 11},
                            'October': {'Rainfall': 309.1, 'Rain frequency': 18},
                            'November': {'Rainfall': 477.5, 'Rain frequency': 20},
                            'December': {'Rainfall': 326.7, 'Rain frequency': 14}},
                   '2014': {'January': {'Rainfall': 269.3, 'Rain frequency': 8},
                            'February': {'Rainfall': 4.0, 'Rain frequency': 1},
                            'March': {'Rainfall': 107.8, 'Rain frequency': 7},
                            'April': {'Rainfall': 157.2, 'Rain frequency': 15},
                            'May': {'Rainfall': 230.6, 'Rain frequency': 14},
                            'June': {'Rainfall': 131.0, 'Rain frequency': 4},
                            'July': {'Rainfall': 68.7, 'Rain frequency': 7},
                            'August': {'Rainfall': 176.9, 'Rain frequency': 13},
                            'September': {'Rainfall': 143.6, 'Rain frequency': 7},
                            'October': {'Rainfall': 132.5, 'Rain frequency': 13},
                            'November': {'Rainfall': 319.6, 'Rain frequency': 19},
                            'December': {'Rainfall': 405.5, 'Rain frequency': 16}},
                   '2015': {'January': {'Rainfall': 92.5, 'Rain frequency': 11},
                            'February': {'Rainfall': 29.0, 'Rain frequency': 2},
                            'March': {'Rainfall': 138.2, 'Rain frequency': 13},
                            'April': {'Rainfall': 208.1, 'Rain frequency': 14},
                            'May': {'Rainfall': 158.9, 'Rain frequency': 12},
                            'June': {'Rainfall': 83.9, 'Rain frequency': 10},
                            'July': {'Rainfall': 84.5, 'Rain frequency': 4},
                            'August': {'Rainfall': 34.2, 'Rain frequency': 8},
                            'September': {'Rainfall': 155.7, 'Rain frequency': 7},
                            'October': {'Rainfall': 130.9, 'Rain frequency': 7},
                            'November': {'Rainfall': 413.9, 'Rain frequency': 19},
                            'December': {'Rainfall': 197.6, 'Rain frequency': 12}}}
    # 0 Soil caracteristic: orga C
    printlist = (['1.7'],
                 # 1 Soil caracteristic: Texture
                 ['Sandy clay loam'],
    ...
    def dictionnary_complete(countfounction, printlist):
        ...
        try:
            ...
            print(
                "Error on rate Mineral Nitrogen fertilizer input data!\n Please check you rate data. Data are not float")
            return
            ##RateNferti toujours >0 voir pour valeur max
        for i in RateNferti_float:
            if i < 0:
        ...
        try:
            ...
            print(
                f"Error on {count}th year of quantity atmospheric deposition input data!\n Please check you rate data. Data are not float")
            return
        ##Quantity organic ferti toujours >0 voir pour valeur max
        count = 0
        for i in atmosphdepostion_float:
        ...
        for i in Yield_float:
            ...
            if i < 0 or i > 40:
                print(
                    f"Error on {count}th year on Yield input data!\n Your data must be 0 tFFB/ha/year ≥ Yield ≤ 40 tFFB/ha/year")
                return
        # Suppresion variable vérification données d'entrée
        del RateNferti_float, Quantityorgaferti_float, atmosphdepostion_float, Yield_float
        del Slope_float, OrganicC_float
...
##################################################################################################################################
##################################################################################################################################
#####################################################Fonction appartenance pour logique flou######################################
